...
- Module path: `github.com/webteractive/warden`. Go 1.26.
...
```bash
cd ~/AI/warden
go mod init github.com/webteractive/warden
```
...
Add `"errors"`, `"os"`, and `"github.com/webteractive/warden/internal/query"` to the imports of `internal/cli/read.go`.
...
Add `"github.com/webteractive/warden/internal/mcpserver"` to that file's imports.
